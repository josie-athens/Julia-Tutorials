...
let
	p1 = qq_plot(kfm.dl_milk, ylab="Breast-milk intake (dl/day)")
	p2 = qq_plot(kfm.mat_weight, ylab="Maternal weight (kg)")
...
@df kfm scatter(
	...
	reg=true, leg=false,
	mc=:midnightblue, ms=2, lc=:indianred
)
...
manifest_format = "2.0"
project_hash = "3c3f86d8c313dea1e44cb3cf6cbcde33314356ff"
