...
# ╔═╡ b1172f9d-6049-42fe-9267-48b41de8985f
begin
	...
	using GLM, StandardizedPredictors
	using MLJ: schema
end
...
# ╔═╡ 774cb459-1824-4d73-acf8-69a0c9dff10b
let
	fig = Figure()
	ax1 = Axis(
		fig[1, 1],
	...
	ax2 = Axis(
		fig[1, 2],
		xlabel="Normal quantiles",
		ylabel="Maternal weight (kg)"
	)

	qqnorm!(ax1, kfm.dl_milk, qqline=:fitrobust, markersize=5, color=:cadetblue)
	qqnorm!(ax2, kfm.mat_weight, qqline=:fitrobust, markersize=5, color=:cadetblue)
...
# ╔═╡ 9e664465-0371-43d9-8aeb-23ba52082aeb
data(kfm) *
mapping(
	:mat_weight => "Maternal weight (kg)",
    :dl_milk => "Breast-milk intake (dl/day)"
) *
(visual(Scatter, markersize=8, color=:indianred) + linear()) * mapping() |>
draw
...
# ╔═╡ 3fe43f3f-05ba-4031-b33d-0ff9f79cfd4e
estat(
...
# ╔═╡ cfbf2f33-e72c-4d10-a745-292d3e45ee66
resid_plot(boy_perf, title="Boys")

# ╔═╡ 4f9ad0f6-82b2-4199-a01a-004d1701f047
resid_plot(girl_perf, title="Girls")

# ╔═╡ 8595bfeb-637c-4991-af81-9f9483b6e962
md"### Homoscedasticity"

# ╔═╡ 7544a122-9e87-4356-b842-f27cd55e0290
rvf_plot(boy_perf, title = "Boys")

# ╔═╡ fac3d204-40b3-4662-a354-5b7b50659239
rvf_plot(girl_perf, title = "Girls")

# ╔═╡ b5556231-744d-41db-be42-bf780c5d2154
variance_plot(boy_perf, title = "Boys")

# ╔═╡ e2f16be8-8f40-479c-8f1c-f94c148fa99b
variance_plot(girl_perf, title = "Girls")

# ╔═╡ 48390d80-428c-432a-8cd0-791d1fa1da89
md"### Influential observations"

# ╔═╡ 27d5b943-df17-4030-816b-0a349b1daab2
cooks_plot(boy_perf, title = "Boys")

# ╔═╡ 2ddad7b4-c946-4365-b406-05a8c57eb457
cooks_plot(girl_perf, title = "Girls")

# ╔═╡ 9ed6aa85-9e86-42e9-85b5-9326804b5cee
res_lev_plot(boy_perf, title = "Boys")

# ╔═╡ 57f8988a-a936-47b4-a5bd-dae950adcc77
res_lev_plot(girl_perf, title = "Girls")

# ╔═╡ 4b68bbdf-eda8-4af5-9e1b-21d201b06313
cook_lev_plot(boy_perf, title = "Boys")

# ╔═╡ 687c0c34-43e7-4484-9195-893f79bb13e6
cook_lev_plot(girl_perf, title = "Girls")
...
manifest_format = "2.0"
project_hash = "0c19a742285479143d231cd72846bb89011a6a53"
