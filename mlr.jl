...
# ╔═╡ 46002c6b-8a07-41a6-ada1-71dfb3804948
let
	p1 = qq_plot(kfm.dl_milk, ylabel="Breast-milk intake (dl/day)")
	p2 = qq_plot(kfm.mat_weight, ylabel="Maternal weight (kg)")
...
# ╔═╡ 1bc60257-fb38-4f05-9973-761431a4df96
@df kfm scatter(
	:mat_weight, :dl_milk,
	xlabel="Maternal weight (kg)",
	ylabel="Breast-milk intake (dl/day)",
	reg=true, leg=false,
	mc=jama[1], ms=2, lc=jama[2]
)
...
@df kfm scatter(
	...
	xlabel="Maternal weight (kg)",
	ylabel="Breast-milk intake (dl/day)",
	reg=true, lw=2, ms=3, color_palette=jama
)
...
# ╔═╡ f9a5c930-d777-4a84-9361-156067b86ea7
let
...
# ╔═╡ 9896921a-2397-46a0-bed3-4285965f31c3
let
...
# ╔═╡ 822bc402-49e2-43d6-9d62-2f07432a3f67
let
...
# ╔═╡ c4b401f3-7597-4b01-9907-9375349be32d
let
...
# ╔═╡ 60c4628e-a239-44f5-a818-7463a50bfb5c
let
...
# ╔═╡ eb4e0707-414c-4e65-b591-68d81b360ac4
let
...
manifest_format = "2.0"
project_hash = "846745d98018538d45a2ba654bb5ef9794997fa4"
...
git-tree-sha1 = "153f4ca66496d925ccde1ded1a9364e946e0710d"
...
git-tree-sha1 = "e2f63c29f2a70732dcda7794e77b0eee624befad"
...
git-tree-sha1 = "f3063c966d3285158aeb4cf2a9bfe786b838482b"
...
[[deps.TexTables]]
deps = ["Compat", "DataFrames", "DataStructures", "Distributions", "Format", "GLM", "Parameters", "StatsBase", "StatsModels"]
git-tree-sha1 = "7041d8bc4de0027fea0b1fe72a36a6cc12e1e340"
