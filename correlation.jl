...
begin
	...
	using StatsPlots, CausalityTools, HypothesisTests
	using MLJ: schema
end
...
let
	p1 = qq_plot(tuzson.extension, ylabel = "Extension (°/s)")
	p2 = qq_plot(tuzson.flexion, ylabel = "Flexion (°/s)")
...
let
	...
	p1 = @df a3 groupedbar(
		...
		color_palette=jama, opacity=0.8
	)
	p2 = @df a5 groupedbar(
		:sex, :count, group=:value,
...
manifest_format = "2.0"
project_hash = "71628492fb0e2406d206395619ae5a2b3b47b185"
