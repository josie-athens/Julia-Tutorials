...
# ╔═╡ 4083c593-a384-4a90-b500-e904478bad07
data(birth) *
...
# ╔═╡ 3f7a6afc-aaa4-4bae-bfb6-2f55f07c0b10
md"""
!!! note
...
# ╔═╡ 2243bf13-7d71-48ab-af72-a52ce724f529
data(wcgs) *
...
# ╔═╡ 275dd06d-6964-4d41-b5bc-5d0e18c66c58
data(wcgs) *
mapping(
	:sbp => "SBP (mm Hg)",
...
# ╔═╡ 9f106f80-145f-4ad0-8451-19abf4453e39
hist(wcgs.sbp)
...
# ╔═╡ c4c5d0a8-cd14-4e48-b086-ce7013f39697
let
	f = Figure()
	Axis(f[1, 1], xlabel="SBP (mm Hg)")

	controls = @subset(wcgs, :chd == "No CHD")
	cases = @subset(wcgs, :chd == "CHD")
...
# ╔═╡ ddb93307-b4a5-472d-b264-cd176e36bae3
md"""
!!! tip

	We can construct a quick QQ-plot with the function `qq_plot`. This function uses as main input, the vector to be plotted.
"""

# ╔═╡ b37e21b2-61a8-4dbd-8d8e-e7ddcf794ded
...
# ╔═╡ fc5b785c-0b64-4102-96e6-406779e0fcce
...
manifest_format = "2.0"
project_hash = "49ebbd9b6029f3b659c31be73959501e9f255026"
...
git-tree-sha1 = "6d98d5bcde6c920f3b735238f3cfa8ee5c37dece"
