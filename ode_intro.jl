...
@df sol_df plot(
	...
	xlab="Time (t)",
	ylab="u(t) (μm)",
	lw=2, lc=:firebrick, leg=:outertopright
)
...
plot(lor_sol, leg=:outertopright)
...
plot(lor_sol, idxs=(1,2,3), dense=false)
...
plot(lor_sol, idxs=(0,2), lc=:indianred)
...
plot(Big_sol, leg=:outertopright, lw=1.5)
...
manifest_format = "2.0"
project_hash = "f1590e34f4ad53a455606bd15740ddfe069d20b3"
