...
begin
    ...
    using CategoricalArrays, DifferentialEquations
	using StatsPlots
	using MLJ: schema
end

# ╔═╡ 2d6a8842-e6da-41e1-a38f-42b1ca9d0751
include("pubh.jl");
...
This notebook will get you started with `DifferentialEquations` by introducing you to the functionality for solving ordinary differential equations (ODEs). While some of the syntax may be different for other types of equations, the same general principles hold in each case. Our goal is to give a gentle and thorough introduction that highlights these principles in a way that will help you generalize what you have learned.
"""
...
# ╔═╡ aeb24244-26e1-48c1-88bc-2895042393dd
@df sol_df plot(
	:timestamp, :value,
	xlab="Time (t)",
	ylab="u(t) (μm)",
	lw=2, lc=jama[1], leg=false
)
...
As a plot recipe, we can annotate the result using any of the [Plots.jl attributes](http://docs.juliaplots.org/dev/attributes/).
...
# ╔═╡ 9646ea68-3b34-4fa7-9f95-b4e00ca8d23a
let
	plot(sol, lc=jama[1])
	plot!(
		sol.t, 
		t -> 1.0*exp(0.98t),
		w=2, ls=:dash, leg=:outertopright,
		label="True Solution",
		color_palette=jama
	)
end
...
plot(lor_sol, leg=:outertopright, color_palette=jama)
...
plot(lor_sol, idxs=(1,2,3), lc=jama[1])
...
plot(lor_sol, idxs=(1,2,3), dense=false, lc=jama[1])
...
plot(lor_sol, idxs=(0,2), lc=jama[2], leg=false)
...
plot(Big_sol, leg=:outertopright, lw=1.5, color_palette=jama)
...
manifest_format = "2.0"
project_hash = "20ed5996b77a5fa9b27c8ea66ddf92f1a0b2020c"
