...
# ╔═╡ f6896653-8ecc-4ceb-9505-60848a0b3298
# ╠═╡ show_logs = false
begin
	using DataFramesMeta, RCall, MLJ
	import Statistics
	using StableRNGs
...
# ╔═╡ 59c6f024-2361-4a77-b902-6d76e77251f6
begin
...
# ╔═╡ 40b80936-4c16-4414-a95d-4cc0c7f27986
begin
...
md"""
# Classification with the MLJ Interface
...
# ╔═╡ c43054a7-368e-4b92-af82-91f06816f119
md"Loading `MLJ` libraries."
...
# ╔═╡ 6eedda82-6477-4e8b-b242-2074a74ae0fb
md"Loading plotting libraries."
...
Plots.plot(fitted_params(pruned_mach).tree)
...
# ╔═╡ 41c4e75f-0b0c-45c7-9a9f-1033fc474cf2
DT.confusion_matrix(string.(pruned_ȳ), string.(y[test]))
...
Plots.plot(fitted_params(dt_mach).tree)
...
# ╔═╡ 28fb8f3f-35c3-43de-acdb-4794dca91756
DT.confusion_matrix(string.(dt_ȳ), string.(y[test]))
...
# ╔═╡ 2e6ad5cf-b7cd-4b21-a13d-46f69f0b62ca
DT.confusion_matrix(string.(forest_ȳ), string.(y[test]))
...
# ╔═╡ 2ff5422c-ca6d-4b5a-86f7-fa0bff23b2a6
...
# ╔═╡ db3107fb-a0ed-48fa-975f-967b8542deec
lda_x = MLJ.transform(lda_mach); lda_x |> size

# ╔═╡ 58624be9-fdc5-418e-a9bb-014a346e7254
first(lda_x, 5)
...
# ╔═╡ ff5878a5-ff6d-4ea8-a8f3-04f440d8894a
data(lda_df) *
mapping(
...
# ╔═╡ 43b8e13b-31dc-486d-a299-395deab5445e
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "7574a7f77bf4a3eb77bacf5cedf7353bfbaa8729"
