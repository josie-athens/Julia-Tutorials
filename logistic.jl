...
eff_3 = empairs(model_2, dof=dof_residual, padjust=BH_adj, invlink=inv_logit)

# ╔═╡ ceef757c-ed52-4b6d-9761-7ddaf6abd441
@df eff_3 scatter(
	:mf_cont, :agegrp, xerr=:err,
	ms=3, leg=false
)
...
manifest_format = "2.0"
project_hash = "a823ca278b7388b69d969466631a3acc8f83449b"
