...
# ╔═╡ be9076ba-f68a-4131-abe9-112ab5a3684c
# ╠═╡ disabled = true
#=╠═╡
let
	hodg = DataFrames.combine(groupby(hodgkin, :Group), :ratio=>(x->fit(Normal, x))=>:d)
...
# ╔═╡ e9be3561-029d-4e16-8ba7-ee87047a15d9
# ╠═╡ disabled = true
#=╠═╡
let
...
# ╔═╡ c8a3770b-9d49-4220-936c-bc03491929c4
smokew_bst = pubh.gen_bst_df(@formula(bweight ~ smoking), data=smokew) |> rcopy

# ╔═╡ 643ecace-8550-4662-8479-168f70c46472
strip_error(
	:smoking, :bweight,
  	smokew, smokew_bst,
  	xlab = "Smoking status",
...
# ╔═╡ 166af0ac-4959-41a7-8b2e-6ad0cd1b23f8
...
# ╔═╡ 434bd2de-f65d-4424-aa25-c3b6f84eee9c
effect_plot(
	:smoking, :bweight, smoke_eff,
	xlab = "Smoking status",
	ylab = "Birth weight (kg)"
)
...
# ╔═╡ 43e2fa0e-4b8d-4092-a738-7ec62c561304
let
...
# ╔═╡ 42163b32-ec7e-471c-9958-2e498ae1527d
resid_plot(air_perf)
...
```julia
let
	fent_bst = pubh.gen_bst_df(@formula(pain ~ group), data=fent) |> rcopy

	strip_error(
		:group, :pain, fent, fent_bst,
		xlab = "Cohort",
		ylab = "Pain reduction"
	)
end
...
# ╔═╡ f2f3143d-0ce6-4c69-86f6-9f04fbe5a1d1
fent_bst = pubh.gen_bst_df(@formula(pain ~ group), data=fent) |> rcopy

# ╔═╡ b78935a7-d2e5-4177-82d7-a9189e00e5c3
strip_error(
	:group, :pain, fent, fent_bst,
	xlab = "Cohort",
	ylab = "Pain reduction"
...
manifest_format = "2.0"
project_hash = "c2938fb0780787a1df257dfd4f8038af79e7e1e2"
