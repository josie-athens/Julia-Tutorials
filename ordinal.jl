...
# ╔═╡ 9a2dd25b-a19a-47b5-9c29-b1e8c218e382
data(eff_1) *
mapping(
    :oc => sorter(levels(rothman.oc)) => "Oral contraceptives",
    :stroke_cont => "P (Stroke)",
...
# ╔═╡ dcb01279-8f13-40bf-bbb9-7ea161f208f5
let
...
# ╔═╡ 42021bc6-2b35-4252-ab4b-caae6907bded
begin
  	plt = data(endom_eff) *
  	mapping(
...
manifest_format = "2.0"
project_hash = "c714a9b0c98148bb2fd6e56ba9d00d4f5c1c9d59"
