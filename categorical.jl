...
begin
	...
	using DataFrameMacros, TexTables, CategoricalArrays
	using RCall, MLJ
	using MLJ: schema
end
...
!!! note
	...
	Options for `method` are: `"cohort.count"` (default), `"cohort.time"`, `"case.control"` and `"cross.sectional"`.	
"""

# ╔═╡ 9edd0836-2ca4-45af-b717-45833a8ad0ae
md"""
It is also possible to make calculations, using the information from a standard two-by-two table (i.e., as an immediate command).
...
tabulate(@filter(cancer, :age == "25-34"), :etoh, :status)
...
# ╔═╡ 24ecdd01-0297-402b-b29e-8ea52cb93602
levels!(breast2.Weight, ["Underweight", "Normal", "Over (11-24%)",
		"Over (25-39%)", "Over (> 39%)"]);

# ╔═╡ b92c1522-df20-4145-a9bc-6a7427883e4b
...
# ╔═╡ 63eaf614-e1e9-4cc6-85bf-a2a873e27690
# ╠═╡ disabled = true
#=╠═╡
let
	plt = data(breast_df |> dropmissing) *
	mapping(
  		:Exposure => sorter(unique(breast_df.Exposure)),
  		:OR => "Odds Ratio"
	) *
	(
...
# ╔═╡ bc2d645f-d47c-4574-8b00-2b69a8b54711
coerce!(
	breast2,
	:Biopsy => Multiclass,
	:Weight => Multiclass
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "f2958d085e47691aa45684aaa0908c23878e6b66"
