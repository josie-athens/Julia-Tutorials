...
# ╔═╡ 4e17be2b-de14-4c1b-a5a5-d5eb9d20de28
let
	fig = Figure()
...
# ╔═╡ db3140e5-9aa5-4ec2-b2e1-f3d781d1dc07
let
...
# ╔═╡ a8f3c33f-24cc-4661-9018-dd3c07562829
let
	layers = visual(Scatter, markersize=7, color=:cadetblue) + smooth()
...
# ╔═╡ 35fc343a-1cfe-435a-a2d0-326e3733171d
let
...
# ╔═╡ 1a8e36ac-26c6-4b3b-a1c9-e147ae751f7e
let
...
# ╔═╡ cbbc4372-f428-4a16-818f-04a22685bccc
let
	p1 = data(bw_sex) * 
	mapping(
		:Gestation => "Gestational weeks",
...
manifest_format = "2.0"
project_hash = "14cfbbeb18f6b7f5682de3395c215148400d4ce6"
