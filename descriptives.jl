...
begin
	...
	using TexTables, RCall, MLJ, CategoricalArrays
end

# ╔═╡ 793bb0c4-a64e-4c66-b1ac-d65c97fcca81
begin
...
# ╔═╡ 8d2b256f-7961-4aff-b77d-368ffa2895fc
pubh.cross_tbl(
...
# ╔═╡ 1ff18371-b6eb-47fd-b764-9a59edd2cc6a
R"""
wcgs |>
mutate(
	chd = relevel(chd, ref = "CHD")
...
```julia
tabulate(wcgs, :chd, :beh_pat)
```
""" |> hint

# ╔═╡ 9e4df137-81d8-48e3-a4f5-a5249567b513
tabulate(wcgs, :chd, :beh_pat)
...
# ╔═╡ 63567de8-c222-4302-b2e5-dbe20eb640a9
describe(
	@select(kfm, {Not(1, 3)}),
...
# ╔═╡ 32e51520-5ef9-4453-adbd-cb9c85c4a076
...
# ╔═╡ 9ed76441-d826-4eb5-8e12-c5caca9a803b
estat(
...
# ╔═╡ 3be03beb-a4cb-4fc5-9056-e61cf9f65d38
estat(
...
manifest_format = "2.0"
project_hash = "51e20c7303068c390a00777af95a649c875d5db5"
