...
# ╔═╡ e82cd8eb-518a-497c-bd76-b9c111430159
data(lotka_melt) *
mapping(
  :timestamp => "Time (days)",
  :value => "y (t)",
...
# ╔═╡ 7788a818-7ccd-407d-8073-90ca57d2f9dd
let
...
# ╔═╡ 3706a86e-0bad-4159-b23a-f2946a4aeeb4
data(lotka_df) *
mapping(
  :Prey,
  :Predator
...
# ╔═╡ 6eff0687-07d1-40bc-bdc6-e1f74530b99f
let
...
# ╔═╡ 8d2eaf95-139c-4ea0-a939-5fc54219ff47
data(hiv_sol) *
mapping(
  :timestamp => "Time (hr)",
...
# ╔═╡ 59bde970-b4a2-4e2c-909b-b5597767471a
data(hiv_sol) *
mapping(
  :timestamp => "Time (hr)",
...
# ╔═╡ e93d83d5-2593-471c-a921-dcb8126ed85d
data(hiv_sol) *
mapping(
  :timestamp => "Time (hr)",
  :value3 => "Virus in FDC"
...
manifest_format = "2.0"
project_hash = "c236ac89ab934dd964414a243a126f5a3b8dadf1"
